...
# directory for logging into
    ...
    print(f"Logging into: {log_root_path}")
    ...
    #env.training = False  # Disable training mode to prevent updates to normalization stats
    #env.norm_reward = False  # Disable reward normalization if not needed
