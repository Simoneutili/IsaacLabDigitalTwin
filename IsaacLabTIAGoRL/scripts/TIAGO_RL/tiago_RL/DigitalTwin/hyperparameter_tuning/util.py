...
def execute_job(
    ...
    if test_mode:
        ...
        print(f"experiment_info_pattern: {experiment_info_pattern}, logdir_pattern: {logdir_pattern}")
        ...
        print(f"experiment_name: {experiment_name}, logdir: {logdir}")
        process.wait()
